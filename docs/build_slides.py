        ...
        "blocks": [
            (
                ...
                [
                    ...
                    (
                        "**enum 타입 안전(EnumSort)** — 다른 enum이 같은 값 이름을 써도 안전.",
                        0,
                    ),
                    (
            ...
            (
                ...
                [
                    ...
                    (
                        ...
                        "표집 추정(신뢰구간). PRISM은 소형 모델 교차검증 테스트 오라클.",
                        1,
                    ),
                ],
            ),
            ...
            (
                ...
                [
                    (
                        ...
                        '분리해 "이 정책에선 승률이?"를 추정("Pmax 아님" 라벨).',
                        0,
                    ),
                    (
                        "**자체 문법 `.lf`** — YAML을 벗고 전용 DSL로 승격. `=`(대입)·`==`(비교)를 "
                        "문법이 구분, 프라임 표기 제거. IR은 불변이라 백엔드 무회귀.",
                        0,
                    ),
                    (
                        "**구조 단순화** — PRISM을 *테스트 전용 교차검증 오라클*로 내리고, 사용자 "
                        "백엔드를 `check`·`bmc`·`sim` 셋으로. 던전 예제도 하나로 통합.",
                        0,
                    ),
                ],
            ),
        ...
        "blocks": [
            (
                ...
                [
                    ...
                    (
                        "단, 밸런스 *튜닝*(승률·분포)은 4차에서 sim **추정**의 목표로 들어왔다.",
                        2,
                    ),
                    (
